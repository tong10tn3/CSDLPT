...
{
    public partial class frmCTDDH : DevExpress.XtraEditors.XtraForm
    {
        ...
        public frmCTDDH(String MSDDH, frmDDH a)
        {
            this.MSDDH = MSDDH;
            frmDDH = a;
            InitializeComponent();
        ...
        private void txtMSDDH_EditValueChanged(object sender, EventArgs e)
        {
